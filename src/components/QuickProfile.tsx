...
export default function QuickProfile() {
  ...
  return (
    <div className="bg-white border border-red-100 shadow-sm p-6 rounded-2xl w-full h-full flex flex-col justify-between overflow-y-auto max-h-full">
      <div className="flex items-center gap-2 mb-4 border-b border-red-500/10 pb-3 shrink-0">
