          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="gen-card bg-red-50 p-5 rounded-2xl space-y-4">
              ...
              <div>
                ...
                <AIAssistedInput type="text" value={formData.tahunAjaran} onChange={e => setFormData({...formData, tahunAjaran: e.target.value})} className="w-full bg-white border border-black rounded-xl p-3 text-black text-sm focus:border-orange-500 transition-all" />
              </div>

              <div className="grid grid-cols-2 gap-2">
                <div>
                  <label className="block text-xs font-medium text-gray-600 mb-1">Jenjang</label>
                  <select value={formData.jenjang} onChange={e => setFormData({...formData, jenjang: e.target.value})} className="w-full bg-white border border-black rounded-xl p-3 text-black text-sm focus:border-orange-500 transition-all">
                ...
                <div>
                  ...
                  <select value={formData.fase} onChange={e => setFormData({...formData, fase: e.target.value})} className="w-full bg-white border border-black rounded-xl p-3 text-black text-sm focus:border-orange-500 transition-all">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <select value={formData.kelas} onChange={e => setFormData({...formData, kelas: e.target.value})} className="w-full bg-white border border-black rounded-xl p-3 text-black text-sm focus:border-orange-500 transition-all">
                ...
                <div>
                  ...
                  <select value={formData.mapel} onChange={e => setFormData({...formData, mapel: e.target.value})} className="w-full bg-white border border-black rounded-xl p-3 text-black text-sm focus:border-orange-500 transition-all">
                ...
                <div className="md:col-span-2">
                  ...
                  <select 
                    ...
                    className="w-full bg-white border border-black rounded-xl p-3 text-black text-sm focus:border-orange-500 transition-all"
                  >
                  ...
                  {formData.isCustomTopik && (
                    <AIAssistedInput type="text" 
                      ...
                      className="w-full bg-white border border-black rounded-xl p-3 text-black text-sm focus:border-orange-500 transition-all mt-3" 
                    />
                  )}
                </div>
              </div>
              ...
              <div>
                ...
                <select value={formData.tingkatanKognitif} onChange={e => setFormData({...formData, tingkatanKognitif: e.target.value})} className="w-full bg-white border border-black rounded-xl p-3 text-black text-sm focus:border-orange-500 transition-all">
              ...
              <div>
                ...
                <AIAssistedInput type="text" value={formData.namaSekolah} onChange={e => setFormData({...formData, namaSekolah: e.target.value})} className="w-full bg-white border border-black rounded-xl p-3 text-black text-sm focus:border-orange-500 transition-all" />
              </div>

              <div>
                <label className="block text-xs font-medium text-gray-600 mb-1">Nama Guru</label>
                <AIAssistedInput type="text" value={formData.namaGuru} onChange={e => setFormData({...formData, namaGuru: e.target.value})} className="w-full bg-white border border-black rounded-xl p-3 text-black text-sm focus:border-orange-500 transition-all" />
              </div>

              <div>
                <label className="block text-xs font-medium text-gray-600 mb-1">Nomor Induk Guru</label>
                <div className="flex gap-2">
                  <select value={formData.jenisNipGuru} onChange={e => setFormData({...formData, jenisNipGuru: e.target.value})} className="w-1/3 bg-white border border-black rounded-xl p-3 text-black text-sm focus:border-orange-500 transition-all">
                  ...
                  <AIAssistedInput type="text" value={formData.nipGuru} onChange={e => setFormData({...formData, nipGuru: e.target.value})} className="w-2/3 bg-white border border-black rounded-xl p-3 text-black text-sm focus:border-orange-500 transition-all" />
                </div>
              </div>

              <div>
                <label className="block text-xs font-medium text-gray-600 mb-1">Kepala Sekolah</label>
                <AIAssistedInput type="text" value={formData.kepalaSekolah} onChange={e => setFormData({...formData, kepalaSekolah: e.target.value})} className="w-full bg-white border border-black rounded-xl p-3 text-black text-sm focus:border-orange-500 transition-all" />
              </div>

              <div>
                <label className="block text-xs font-medium text-gray-600 mb-1">Nomor Induk Kepala Sekolah</label>
                <div className="flex gap-2">
                  <select value={formData.jenisNipKepalaSekolah} onChange={e => setFormData({...formData, jenisNipKepalaSekolah: e.target.value})} className="w-1/3 bg-white border border-black rounded-xl p-3 text-black text-sm focus:border-orange-500 transition-all">
                    <option value="NIP">NIP</option>
                    <option value="NUPTK">NUPTK</option>
                    <option value="NIY">NIY</option>
                    <option value="NRG">NRG</option>
                  ...
                  <AIAssistedInput type="text" value={formData.nipKepalaSekolah} onChange={e => setFormData({...formData, nipKepalaSekolah: e.target.value})} className="w-2/3 bg-white border border-black rounded-xl p-3 text-black text-sm focus:border-orange-500 transition-all" />
                </div>
              </div>
              
              <div>
                <label className="block text-xs font-medium text-gray-600 mb-1">Tempat, Tanggal Penetapan</label>
                <AIAssistedInput type="text" value={formData.tempatTanggal} onChange={e => setFormData({...formData, tempatTanggal: e.target.value})} className="w-full bg-white border border-black rounded-xl p-3 text-black text-sm focus:border-orange-500 transition-all" />
              </div>
            </div>
