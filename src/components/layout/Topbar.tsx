                ...
                <div className="p-4 border-b border-gray-200 bg-gray-50">
                  {loading ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-2">
                      ...
                      <button onClick={handleLogin} className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-white hover:bg-gray-50 text-gray-700 border border-gray-200 shadow-sm rounded-lg transition-colors text-xs font-bold uppercase tracking-widest">
