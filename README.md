...
[![Website](https://img.shields.io/badge/Website-digen.id-blue?style=for-the-badge&logo=google-chrome)](https://digen.id)
...
graph TB
    ...
    C -->|API Calls| D[Cloudflare Workers]
    D -->|Query| E[Cloudflare D1 Database]
    D -->|Auth| F[Google OAuth 2.0]
    D -->|AI Requests| G[Google Gemini API]
    C -->|Direct AI| G
    D -->|Assets| H[Cloudflare R2 Storage]
...
[![Website](https://img.shields.io/badge/Website-digen.id-blue?style=for-the-badge)](https://digen.id)
[![Email](https://img.shields.io/badge/Email-p.e.muryadi@gmail.com-red?style=for-the-badge&logo=gmail)](mailto:p.e.muryadi@gmail.com)
[![WhatsApp](https://img.shields.io/badge/WhatsApp-Admin-25D366?style=for-the-badge&logo=whatsapp)](https://wa.me/6281347697809)
[![Saweria](https://img.shields.io/badge/Donate-Saweria-orange?style=for-the-badge)](https://saweria.co/pemuryadi)
